...
const CACHE = CACHE_PREFIX + '2026.09.12C-399fb454';
const ASSETS = [
  './',
  './index.html',
  './manifest.json?v=2026.09.12C-399fb454',
  './icon-192.png?v=2026.09.12C-399fb454',
  './icon-512.png?v=2026.09.12C-399fb454',
  './icon-180.png?v=2026.09.12C-399fb454'
];
