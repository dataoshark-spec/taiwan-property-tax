...
const CACHE = CACHE_PREFIX + '2026.09.26B-four-decimals';
const ASSETS = [
  './',
  './index.html',
  './manifest.json?v=2026.09.26B-four-decimals',
  './icon-192.png?v=2026.09.26B-four-decimals',
  './icon-512.png?v=2026.09.26B-four-decimals',
  './icon-180.png?v=2026.09.26B-four-decimals'
];
