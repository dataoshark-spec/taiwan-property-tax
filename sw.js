...
const CACHE = CACHE_PREFIX + '2026.09.14B-held-input';
const ASSETS = [
  './',
  './index.html',
  './manifest.json?v=2026.09.14B-held-input',
  './icon-192.png?v=2026.09.14B-held-input',
  './icon-512.png?v=2026.09.14B-held-input',
  './icon-180.png?v=2026.09.14B-held-input'
];
