...
const CACHE = CACHE_PREFIX + '2026.09.20C-empty-dash';
const ASSETS = [
  './',
  './index.html',
  './manifest.json?v=2026.09.20C-empty-dash',
  './icon-192.png?v=2026.09.20C-empty-dash',
  './icon-512.png?v=2026.09.20C-empty-dash',
  './icon-180.png?v=2026.09.20C-empty-dash'
];
