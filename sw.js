...
const CACHE = CACHE_PREFIX + '2026.09.13B-input-gesture';
const ASSETS = [
  './',
  './index.html',
  './manifest.json?v=2026.09.13B-input-gesture',
  './icon-192.png?v=2026.09.13B-input-gesture',
  './icon-512.png?v=2026.09.13B-input-gesture',
  './icon-180.png?v=2026.09.13B-input-gesture'
];
