...
const CACHE = CACHE_PREFIX + '2026.09.12C-e7e2b0a7';
const ASSETS = [
  './',
  './index.html',
  './manifest.json?v=2026.09.12C-e7e2b0a7',
  './icon-192.png?v=2026.09.12C-e7e2b0a7',
  './icon-512.png?v=2026.09.12C-e7e2b0a7',
  './icon-180.png?v=2026.09.12C-e7e2b0a7'
];
